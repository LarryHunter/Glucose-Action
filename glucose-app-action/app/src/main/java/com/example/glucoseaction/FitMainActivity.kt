...
import com.example.glucoseaction.home.FitStatsFragment
import com.example.glucoseaction.model.FitActivity
import com.example.glucoseaction.model.FitRepository
import com.example.glucoseaction.tracking.FitTrackingFragment
import com.example.glucoseaction.tracking.FitTrackingService
 ...
 */
class FitMainActivity : AppCompatActivity(), FitStatsFragment.FitStatsActions,
    FitTrackingFragment.FitTrackingActions {
    ...
    override fun onStartActivity() {
        updateView(
            ...
            arguments = Bundle().apply {
                putSerializable(
                    FitTrackingFragment.PARAM_TYPE,
...
//                val arguments =
//                    Bundle().apply { putSerializable(FitTrackingFragment.PARAM_TYPE, type) }
//                showGlucoseDialog(arguments)
//            }
            DeepLink.STATS -> {
                updateView(FitStatsFragment::class.java)
            }
...
//    private fun showGlucoseDialog(@Suppress("UNUSED_PARAMETER") arguments: Bundle? = null) {
//        val builder = AlertDialog.Builder(this@FitMainActivity)
//        lateinit var glucoseDialog: AlertDialog
//
//        builder
//            .setTitle("Estimated Glucose Value")
//            .setIcon(R.mipmap.ic_launcher)
//            .setMessage("Your estimated glucose value is 105 and slowly rising.")
//            .setPositiveButton(R.string.dialog_text_ok) { _, _ ->
//                glucoseDialog.dismiss()
//            }
//        glucoseDialog = builder.create()
//        glucoseDialog.show()
//    }
     ...
     */
    private fun handleSearchIntent(@Suppress("UNUSED_PARAMETER") searchQuery: String?) {
        // The app does not have search functionality, we could parse the search query, but the normal use case
    ...
    private fun showDefaultView() {
        val fragmentClass =
            if (FitRepository.getInstance(this).getOnGoingActivity().value != null) {
